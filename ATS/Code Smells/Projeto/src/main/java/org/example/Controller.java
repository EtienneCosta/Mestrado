...
public class Controller {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            ficheiroInvalido(view, fi, e.getMessage());
        }
        catch(IOException e){
            ficheiroInvalido(view, er, e.getMessage());
        }
        catch (ClassNotFoundException e) {
            ficheiroInvalido(view, "Classe nao encontrada:", e.getMessage());
        }
            ...
            switch (view.menu()) {
                ...
                case 2:
                    ...
                    for (char i : passwordArray){
                        password1 = new StringBuilder().append(password1).append(i).toString();
                    }

                    Boolean nc=!ta.existeNome(nomeCod);
                    if (Boolean.FALSE.equals(nc)) {
                ...
                case 3:
                    ...
                    try {
                        ...
                        ficheiroInvalido(view, "Oops, nao consegui ler o ficheiro :(\n", e.getMessage());
                    }
                    break;
                ...
                case 5:
                    //ler binario
                    try{
                        ta = TrazAqui.lerFicheiro(view.nomeFicheiro());
                    }
                    catch(FileNotFoundException e){
                        ficheiroInvalido(view, fi, e.getMessage());
                    }
    ...
    public static void ficheiroInvalido(View view, String s, String message) {
        view.print(s + message);
    }
            ...
            switch(view.menuTransportadora()){
                ...
                case 4:
                    ...
                    try {
                        ...
                        if (lojaQuePreparouEncomenda instanceof  LojaComFila){
        ...
        while (!sair){
            switch(view.menuUtilizador()){
                case 1:
                    ...
                    for (User u : contas){
                        if (u instanceof Lojas || u instanceof LojaComFila)
                ...
                case 2:
                    ...
                    try {
                        ficheiroInvalido(view, "Digite o codigo da encomenda que deseja ser transportada\n\n", ta.utilizadorEncomendasParaEntrege(nomeCod));
                ...
                case 3:
                    ...
                    //Aceitar Transporte
                    try {
                        ficheiroInvalido(view, "Qual a encomenda que quer aceitar?\n", ta.utilizadorEncomendasPorAceitar(nomeCod));
                    ...
                    for (Transportadoras t: todos){
                        ...
                        // contas2.get(encomendaAceitar.getCodLoja()).getClass().getName().equals("LojaComFila")
                        if (contas2.get(encomendaAceitar.getCodLoja()) instanceof LojaComFila){
                ...
                case 4:
                    //Classificar alguem
                    try {
                        ficheiroInvalido(view, "Qual quer classificar? Coloque o codigo de encomenda\n", ta.escolheClassificar(nomeCod));
        ...
        while (!sair){
            switch(view.menuVoluntario()){
                ...
                case 3:
                    ...
                    // lojaQuePreparouEncomenda.getClass().getName().equals("LojaComFila")
                    if (lojaQuePreparouEncomenda instanceof LojaComFila){
                        LojaComFila lojaComFilaAtual = (LojaComFila) lojaQuePreparouEncomenda;
                        tempoDemorado1 += ta.tempoRecolherEntrega(nomeCod, lojaComFilaAtual , met, estadoCovid);
                        lojaComFilaAtual.addTempoEspera(estadoCovid);
            ...
            switch(view.menuLoja()){
                ...
                case 2:
                    ...
                    switch(view.consultarDadosLoja()){
                        case 1:
                            // Ver o meu perfil
                            if (ta.getUser(nomeCod) instanceof LojaComFila){
